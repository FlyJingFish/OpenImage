...
public class MemoryTestRecyclerViewActivity extends Activity {
    ...
    private class RvAdapter extends RecyclerView.Adapter<RvAdapter.MyHolder> {
        ...
        public void onBindViewHolder(@NonNull MyHolder holder, int position) {
            if (layoutType == 4) {
                ...
                layoutParams.width = (int) ScreenUtils.dp2px(MemoryTestRecyclerViewActivity.this, 86 * randoms[position]);
                holder.ivImage.setLayoutParams(layoutParams);
            }else if (layoutType == 1) {
                ViewGroup.LayoutParams layoutParams = holder.ivImage.getLayoutParams();
                layoutParams.width = (int) ScreenUtils.dp2px(MemoryTestRecyclerViewActivity.this, 100);
                layoutParams.height = (int) ScreenUtils.dp2px(MemoryTestRecyclerViewActivity.this, 100);
                holder.ivImage.setLayoutParams(layoutParams);
            } else if (layoutType == 0 || layoutType == 2) {
                ViewGroup.LayoutParams layoutParams = holder.ivImage.getLayoutParams();
                layoutParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
                layoutParams.height = (int) ScreenUtils.dp2px(MemoryTestRecyclerViewActivity.this, 220);
                holder.ivImage.setLayoutParams(layoutParams);
            }
            ...
            holder.ivImage.setOnClickListener(v -> {
                OpenImage openImage = OpenImage.with(MemoryTestRecyclerViewActivity.this);
                if (layoutType == 4){
                ...
                openImage.setAutoScrollScanPosition(true)
                        ...
                        .setOnExitListener(() -> Toast.makeText(MemoryTestRecyclerViewActivity.this,"onExit",Toast.LENGTH_SHORT).show())
