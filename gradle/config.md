...
implementation 'io.github.FlyJingFish.OpenImage:OpenImageFullLib:aar_version'
```
...
implementation 'io.github.FlyJingFish.OpenImage:OpenImageCoilLib:aar_version'
```
...
implementation 'io.github.FlyJingFish.OpenImage:OpenImageGlideLib:aar_version'
```
...
implementation 'io.github.FlyJingFish.OpenImage:OpenImageLib:aar_version'
...
#### B、如果您引用的库是 OpenImageLib 或 OpenImageGlideLib 或 OpenImageCoilLib 需要查看视频的功能，需要以下步骤
