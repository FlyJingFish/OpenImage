...
final class ProgressManager {
    ...
    private static final String IDENTIFICATION_NUMBER = "?FlyJingFish=";
    private static final String IDENTIFICATION_HEADER = "FlyJingFish";
    ...
    public void removeResponseListeners(String url) {
        if (url == null){
            return;
        }
